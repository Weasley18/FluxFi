...
def send_report_email(to: str, pdf_bytes: bytes, month: str) -> None:
    ...
    subject = f"FluxFi — Monthly Report ({month})"
    html = f"""
    <div style="font-family:sans-serif;max-width:480px;margin:auto">
      <h2 style="color:#2563eb">Your Monthly Financial Report</h2>
      <p>Please find your FluxFi monthly summary for <strong>{month}</strong> attached as a PDF.</p>
      <p style="color:#6b7280;font-size:12px">Generated automatically by FluxFi.</p>
    </div>
    """
...
async def send_reset_email(to: str, reset_link: str) -> None:
    subject = "FluxFi — Password Reset"
    html = f"""
    <div style="font-family:sans-serif;max-width:480px;margin:auto">
      <h2 style="color:#2563eb">Reset your password</h2>
      <p>Click the button below to reset your FluxFi password.
